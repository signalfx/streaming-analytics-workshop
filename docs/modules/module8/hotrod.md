...
This workshop is tested on MacOS and Linux- it should work on Windows as well if requirements below are met. Tips, references, and troubleshooting tips for these components are in the appendix.
